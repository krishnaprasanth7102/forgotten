...
export function IntegrationMode() {
  ...
  return (
    <section id="integration" className="bg-black py-24 sm:py-32 lg:py-48 px-6 border-b border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 text-center lg:text-left">
        <div className="mb-20 flex flex-col items-center lg:items-start">
          ...
          <h3 className="text-5xl sm:text-7xl lg:text-8xl font-black tracking-tighter uppercase mb-8 leading-[0.85] max-w-4xl">INTEGRATION_MODE</h3>
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl leading-relaxed mx-auto lg:mx-0">
        ...
        <Tabs defaultValue="unreal" className="w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-4 flex flex-col gap-12">
              ...
              <div className="space-y-10 bg-white/[0.02] p-10 border border-white/5 text-left">
                 <div className="flex gap-8 items-start group">
                    ...
                    <p className="text-sm sm:text-base text-muted-foreground leading-relaxed pt-1">Inject the <span className="text-white font-black">FORGOTTEN.CORE</span> binary module into your project source.</p>
                 </div>
                 <div className="flex gap-8 items-start group">
                    ...
                    <p className="text-sm sm:text-base text-muted-foreground leading-relaxed pt-1">Bind the unique <span className="text-white font-black">ENTITY_ID</span> key to your tactical world spawner.</p>
                 </div>
                 <div className="flex gap-8 items-start group">
                    ...
                    <p className="text-sm sm:text-base text-muted-foreground leading-relaxed pt-1">Execute <code className="text-red-500 font-black px-1">ACTIVATE_AI()</code> to link the behavior tree.</p>
                 </div>
              </div>
            </div>

            <div className="lg:col-span-8 w-full max-w-[100vw] overflow-hidden">
               {Object.entries(codeExamples).map(([key, code]) => (
                 <TabsContent key={key} value={key} className="m-0 focus-visible:outline-none">
                    <div className="relative group flex flex-col h-full w-full">
                       ...
                       <div className="bg-white/[0.03] border border-white/10 p-10 sm:p-16 font-mono text-sm sm:text-lg leading-relaxed overflow-x-auto whitespace-pre min-h-[350px] flex items-center scrollbar-hide w-full">
