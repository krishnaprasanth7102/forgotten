...
export function ContributionTerminal() {
  ...
  return (
    <section id="protocol" className="bg-black py-24 lg:py-48 px-6 lg:px-12 relative overflow-hidden border-b border-white/10">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-24 items-center relative z-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
           ...
           <h2 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter uppercase mb-10 leading-[0.85]">DEPLOY_YOUR_ENTITY</h2>
           <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed mb-16 max-w-xl">
        ...
        <div className="w-full lg:w-1/2">
           <div className="bg-red-600 p-12 lg:p-20 relative overflow-hidden group">
              ...
              <div className="relative z-10 text-white">
                 <div className="flex items-center gap-6 mb-12">
                   ...
                   <h3 className="text-3xl lg:text-4xl font-black tracking-tighter uppercase">ARSENAL_DATA</h3>
                 </div>
                 ...
                 <div className="space-y-6 mb-16">
                    <div className="flex justify-between items-end border-b border-white/30 pb-4 group/stat">
                       ...
                       <span className="text-4xl lg:text-5xl font-black leading-none">1,204</span>
                    </div>
                    <div className="flex justify-between items-end border-b border-white/30 pb-4 group/stat">
                       ...
                       <span className="text-4xl lg:text-5xl font-black leading-none">8,942</span>
                    </div>
                    <div className="flex justify-between items-end border-b border-white/30 pb-4 group/stat">
                       ...
                       <span className="text-4xl lg:text-5xl font-black leading-none">443</span>
                    </div>
                 </div>

                 <button className="w-full h-20 bg-white text-black font-black uppercase tracking-[0.5em] text-sm hover:bg-black hover:text-white transition-all flex items-center justify-center gap-6 group/btn">
                    ACCESS REPOSITORY
      ...
      {isFormOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-0 sm:p-6 lg:p-12">
          ...
          <div className="relative w-full h-full sm:h-auto sm:max-w-4xl bg-black border sm:border-white/10 p-8 sm:p-16 overflow-y-auto max-h-screen scrollbar-hide">
            <button 
            ...
            {success ? (
              <div className="min-h-[50vh] flex flex-col items-center justify-center text-center space-y-10">
                <div className="size-24 border-2 border-green-500 text-green-500 flex items-center justify-center animate-pulse">
                  <ShieldCheck className="size-16" />
                </div>
                <div>
                  <h3 className="text-5xl font-black tracking-tighter uppercase mb-4">UPLOAD_COMPLETE</h3>
                  <p className="text-muted-foreground font-mono uppercase tracking-[0.4em] text-xs">Entity staging successful. System synchronized.</p>
                </div>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-12 pt-12 sm:pt-0">
                <div className="text-center sm:text-left">
                  <h3 className="text-5xl lg:text-6xl font-black tracking-tighter uppercase mb-4 leading-none">DEPLOY_UNIT</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="space-y-8">
                    ...
                    <div className="space-y-3">
                      ...
                      <input 
                        required
                        className="w-full bg-white/5 border border-white/10 p-5 text-white focus:border-red-600 outline-none uppercase font-black tracking-[0.3em] text-sm"
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea 
                        ...
                        placeholder="Detail tactical behavior and combat patterns..."
                  ...
                  <div className="space-y-8">
                    <div className="grid grid-cols-2 gap-6">
                      <div className="space-y-3">
                        ...
                        <select 
                          className="w-full bg-white/5 border border-white/10 p-5 text-white focus:border-red-600 outline-none uppercase font-black text-xs appearance-none"
                    ...
                    <div className="space-y-3">
                      ...
                      <input 
                        required
                        className="w-full bg-white/5 border border-white/10 p-5 text-white focus:border-red-600 outline-none font-mono text-xs"
                    ...
                    <div className="space-y-3">
                      ...
                      <input 
                        className="w-full bg-white/5 border border-white/10 p-5 text-white focus:border-red-600 outline-none font-mono text-xs"
                        placeholder="GITHUB.COM/ARSENAL/..."
